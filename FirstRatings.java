...
public class FirstRatings {
    ...
    //method should process every record from CSV file of movie information,
    ...
    // test cases for the file and loadMovies method
    public void testLoadMovies(){
        ...
        */
        ...
        for (Movie movie : movies) {
            ...
            if (movie.getMinutes() > minMovLength) {
                countMinutes +=1;
            }
        }
        System.out.println("# comedies in the list: " + countComedies);
        System.out.println("#  movies with more than " +minMovLength+ " minutes in the list: " + countMinutes);
        ...
        System.out.println("Max # of movies directed by any one director: " + maxNumOfMovies);
        System.out.println("# of directors who directed one such movie: " + countDirectors);
        System.out.println("Names of directors who directed one such movie: " + directorsList);
    }

    //method to process every record from CSV "filename", a file of raters and their ratings,
    ...
    //test method to test LoadRaters
    public void testLoadRaters(){
        ...
        /*
        System.out.println("Rater ID + ratings of this rater in between the following lines:");
        System.out.println("---");
        ...
        */
        ...
        System.out.println("# of ratings for the rater with ID " + raterID + ": " + ratingsSize);
        ...
        System.out.println("Maximum # of ratings by any rater: " + maxNumOfRatings);
        ...
        System.out.println("IDs of rater(s) with the most # of movies rated: " + raterWithMaxNumOfRatings);
        ...
        System.out.println("# of ratings movie with ID " + movieID + " has: " + numOfRatings);
        ...
        System.out.println("Total # of movies that were rated: " + uniqueMovies.size());
    }
}
