...
/**
 * This class contains various tests for the methods from FourthRatings.
 *
 */
...
public class MovieRunnerSimilarRatings {
    ...
    public void printSimilarRatingsByDirector () {
        ...
        String directors = "Clint Eastwood,Sydney Pollack,David Cronenberg,Oliver Stone"; // variable
        DirectorsFilter df = new DirectorsFilter(directors);

        String id = "1034"; // variable
    ...
    public void printSimilarRatingsByGenreAndMinutes () {
        ...
        String genre = "Adventure"; // variable
        GenreFilter gf = new GenreFilter (genre);

        int minMin = 100; // variable
